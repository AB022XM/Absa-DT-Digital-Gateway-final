...
@Configuration
@EnableR2dbcRepositories({ "ug.co.absa.africa.digital.gateway.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("ug.co.absa.africa.digital.gateway.repository.search")
